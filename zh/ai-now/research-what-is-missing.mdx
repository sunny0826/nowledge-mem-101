...
<div className="course-playground-workflow"
  ...
  data-course-guide-done-message="模拟完成。仍需在 Nowledge Mem 实际运行并核验研究，本模拟未执行研究。"
...
<Steps>
  ...
  <p className="course-playground-workflow-status course-playground-workflow-status-complete" data-course-guide-done role="status" hidden>模拟完成。仍需在 Nowledge Mem 实际运行并核验研究，本模拟未执行研究。</p>
...
<Card title="保存结果 →" horizontal href="/zh/ai-now/save-the-result">
</Card>
