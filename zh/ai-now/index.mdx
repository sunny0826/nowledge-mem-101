...
<Note>
五课均提供带引导的模拟交互。在电脑浏览器中打开一课，点击**开始模拟**，用虚构的 Atlas 材料练习，再把流程用于 Nowledge Mem。模拟使用预设回答，不调用 AI 或联网搜索。
</Note>
...
从[第 1 课](/zh/ai-now/start-a-grounded-task)开始。每课会准备好示例记忆和来源，打开模拟前无需配置模型或手动导入资料。刷新会重置练习。手机端可以阅读步骤，交互练习请使用电脑浏览器。
