...
<a className="course-cta" href="/ai-now/start-a-grounded-task">Start lesson 1 <span aria-hidden="true">→</span></a>

<Note>
All five lessons include guided interactive practice. On desktop, click **Start the simulation** in lesson 1 when you are ready; lessons 2–5 open the simulation automatically. Learn with fictional Atlas data, then apply the workflow in Nowledge Mem. The simulation uses preset replies and does not call AI or search the web.
</Note>
