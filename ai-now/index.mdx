...
<Note>
All five lessons include guided interactive practice. Open a lesson on desktop to start its simulation automatically and learn with fictional Atlas data, then apply the workflow in Nowledge Mem. The simulation uses preset replies and does not call AI or search the web.
</Note>
