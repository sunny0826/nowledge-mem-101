...
**Learn to leave knowledge for your future self and your AI — by doing it for real.**
...
<CardGroup cols={2}>
  ...
  <Card title="AI Workflow (coming soon)" icon="workflow">
...
<CardGroup cols={2}>
  <Card title="Essentials course" icon="graduation-cap" href="/essentials">
    6 lessons build a complete Capture → Recall loop in about 20 minutes.
  </Card>
