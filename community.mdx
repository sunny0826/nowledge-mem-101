...
<section className="community-section" aria-labelledby="articles">
  ...
  <div className="community-articles">
    <a className="community-share-card" href="https://x.com/guoxudong_/status/2092604004245332474" target="_blank" rel="noopener noreferrer">
      <img className="community-share-cover" src="/cover-image/x-article-memory-hub.jpg" alt="Cover of the X article: a Mac mini at the center of a shared memory hub linking a laptop, server, and phone" width="1200" height="480" loading="lazy" />
    ...
    <a className="community-share-card" href="https://x.com/HaraAmami/status/2091523661077561348" target="_blank" rel="noopener noreferrer">
      <img className="community-share-cover" src="/cover-image/x-article-project-memory.jpg" alt="Cover of the X article: Nowledge Mem at the center of a shared memory connecting many AI tools" width="1200" height="480" loading="lazy" />
    ...
    <a className="community-share-card" href="https://x.com/hbyxabc/status/2093326775862599708" target="_blank" rel="noopener noreferrer">
      <img className="community-share-cover" src="/cover-image/x-article-agent-era.jpg" alt="Cover of the X article: a person choosing between AI agents backed by a shared memory" width="1200" height="480" loading="lazy" />
